// Distilled from crashcat/src/collision/closest-points.ts. @optimize added on the
// entry (a test copy — crashcat itself is never annotated) to stress the full
// pipeline on real barycentric-coordinate math: branches, out-param writes, a
...
export { computeBarycentricCoordinates3d };
